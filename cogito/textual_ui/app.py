...
from cogito.logging import setup_logging, log_path
from cogito.config import AppConfig
from cogito.runtime.function_calling.function_call_support import (
    load_function_entry_points,
)
from cogito.runtime.models import AppContext
from cogito.runtime.conv_manager import ConversationManager
from cogito.runtime.conversation import conversation_path, export_path

from cogito.textual_ui.screens import ChatScreenDark, ChatScreenLight
...
class GPTextual(App):
    def __init__(self, context: Optional[AppContext] = None) -> None:
        ...
        self.file_paths = [str(log_path / "cogito.jsonl")]
        self.merge = True
