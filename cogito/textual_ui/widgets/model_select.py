...
from cogito.runtime import ChatModel, ModelRegistry
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if len(registry):
            ...
            self.provider_select = Static(
                "There are no models configured in `./env/config.yml`. Check the README on how to configure API providers and models."
            )
